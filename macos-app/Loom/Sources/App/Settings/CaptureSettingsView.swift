...
struct CaptureSettingsView: View {
    ...
    var body: some View {
        Form {
            // (The "Browser Extension" section is retired — LoomWebExtension
            // was deleted in the web retirement, and this pane still advertised
            // a copy-path button pointing at a nonexistent folder. The
            // bookmarklet below is the real web-capture path.)
            Section("Web capture bookmarklet") {
                Text("Captures title, URL, selection, and main text from any page in your browser — but not rich media, styled SVG, or canvas resources. Drag the pill into your bookmarks bar.")
                    .font(.system(size: 11, design: .serif))
                    .foregroundStyle(.secondary)
