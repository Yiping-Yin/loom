...
- **Deep-space graphite over flat black.** The dominant canvas is cold, restrained black with a silver-gray lift: quiet, breathable, mysterious. It must not collapse into pure black, pale silver, or a colored blue-black field.

Preferred defaults:

- cold graphite-black surfaces with restrained silver-gray gradients
- **Signature cyan `#4BC5DE`** for identity hairlines, active marks, and tiny proof points
- **Data cyan `#6CE7F2`** for live signals, charts, and thinking states
...
- neon HUD behavior
- navy / black-blue atmosphere pretending to be depth
- champagne-gold or saturated yellow as a current brand accent
